...
export class TaskDropSlot {
    ...
    constructor(public treeService: TreeService,private mianTaskContainer:MainTaskContainer, private biz:TaskDropSlotBiz,private posCalculationRule:PosCalculationRule) { }
    onDragOver($event) {
    ...
    onDrop($event) {
        $event.preventDefault();
        let dragTask:any = this.mianTaskContainer._dragTaskComponent.task;
        ...
        this.biz.moveTask(this.mianTaskContainer._dragTaskComponent,this,this.treeService,this.posCalculationRule);
